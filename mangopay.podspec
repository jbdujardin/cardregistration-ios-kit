#
#  Be sure to run `pod spec lint mangopay-cardregistration-ios-kit' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/jbdujardin/cardregistration-ios-kit.git', :tag => s.version.to_s }
